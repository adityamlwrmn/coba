...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `tw3` (nama_ik, keterangan, nama_user, sasaran, target, realisasi, satuan, bobot, capaian, penjelasan, progress_kegiatan, kendala_permasalahan, strategi_tindak_lanjut, tahun_anggaran, file_data_dukung)
    ...
    if (mysqli_query($con, $sql)) {
        ...
        header("Location: tw3.php"); // Redirect to data view page
        exit();
    } else {
...
<head>
    ...
    <title>Tambah Data Triwulan 3</title>
