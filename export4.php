...
$query = "SELECT * FROM `tw4`";
$stmt = $con->prepare($query);
$stmt->execute();
$result = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Query untuk mendapatkan tahun anggaran yang unik
$yearQuery = "SELECT DISTINCT tahun_anggaran FROM `tw4` ORDER BY tahun_anggaran DESC";
...
<body>
    <div class="container mt-4">
        <a href="tw4.php" class="btn btn-primary mb-2">Kembali</a>
        <h2>Data Triwulan 4</h2>
