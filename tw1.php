...
$tahun_query = "SELECT DISTINCT tahun_anggaran FROM tw1";
...
$indikator_query = "SELECT DISTINCT nama_ik FROM tw1";
...
$sasaran_query = "SELECT DISTINCT sasaran FROM tw1";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <input type="text" id="searchInput" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-4 text-gray-800">Triwulan 1</h1>
                <a href="tambah/add_tw1.php" class="btn btn-primary">Tambah Data</a>
                <a href="export1.php" class="btn btn-success">Export</a>
