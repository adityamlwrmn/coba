...
$tahun_query = "SELECT DISTINCT tahun_anggaran FROM tw3";
...
$indikator_query = "SELECT DISTINCT nama_ik FROM tw3";
...
$sasaran_query = "SELECT DISTINCT sasaran FROM tw3";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-4 text-gray-800">Triwulan 3</h1>
                <a href="tambah/add_tw3.php" class="btn btn-primary">Tambah Data</a>
                <a href="export3.php" class="btn btn-success">Export</a>
